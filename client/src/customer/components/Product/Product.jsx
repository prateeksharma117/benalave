...
const sortOptions = [
  ...
  { name: "Price: High to Low", label: "price_high_to_low", current: false },
];
                        ...
                        {({ open }) => (
                          <>
                            <h3 className="-my-3 flow-root">
                              <Disclosure.Button className="flex w-full items-center justify-between bg-white px-5 py-3 text-sm text-gray-400 hover:text-gray-500">
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
                    ...
                    <div className="py-1">
                      {sortOptions.map((option) => (
                        <Menu.Item key={option.name}>
                          {({ active }) => (
                            <a
                              onClick={() => handleSortOption(option.label)}
                              href={option.href}
          ...
          <section className=" w-full px-[3.6rem]">
            <div className="px-4 py-5 flex justify-center">
              <Pagination variant="outlined" shape="rounded" color="primary" count={product.products?.totalPages}
